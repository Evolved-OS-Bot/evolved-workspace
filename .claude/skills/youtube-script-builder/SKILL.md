...
- [ ] Read `CLAUDE.md` — understand the business, brand voice, and audience before writing anything
...
**Voice and tone — derive from CLAUDE.md and context files:**
...
2. **How-to/benefit-led** — clear and searchable, e.g. "How to Set Up a Claude Code Workspace for Your Business in 20 Minutes"
...
- [ ] Brand voice matches `CLAUDE.md` and context files
