...
def test_acquisition_and_onboarding_shadow_keeps_completion_unavailable(
    ...
    assert observations["prequalification_completion_rate"]["value"] is None
    assert (
        observations["prequalification_completion_rate"]["definition_version"]
        == "ghl-prequalification-v2"
    )
