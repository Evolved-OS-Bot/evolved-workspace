...
POLICIES: dict[str, dict[str, Any]] = {
    ...
    # A confidence-labelled historical baseline. It never substitutes for the
    # appointment-event attendance metric above.
    "sa_listed_show_rate": {
        "definition_version": "sa-listed-show-v1",
        "cycle_requirements": [{"job_id": "reporting-v2-sa-listed-history-refresh", "times": ("06:22", "18:22"), "required": 2}],
        "required_periods": ("week", "28d", "90d"),
        "required_sample": 0,
        "guards": ("tracking_start_enforced", "explicit_y_or_n_only", "blank_rows_excluded", "legacy_baseline_not_event_metric", "no_sheet_write"),
    },
    "sa_listed_conversion_rate": {
        ...
        "required_periods": ("week", "28d", "90d"),
        "required_sample": 0,
        "guards": ("tracking_start_enforced", "unique_list_row_grain", "no_double_counted_service_components", "legacy_baseline_not_event_metric", "no_sheet_write"),
    },
    "cash_goal_progress": {
